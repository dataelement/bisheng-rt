...
// RapidJson (https://code.google.com/p/rapidjson/) documents.
namespace mustache {
...
// error is signalled (TODO: probably doesn't work in all paths), and evaluates
// that tag. Output is accumulated in 'out'.
void RenderTemplate(
    const std::string& document, const std::string& document_root,
