...
class MrcnnTableDetect(Mrcnn):
    def __init__(self, alg_params, alg_inputs, alg_ouputs, **kwargs):
        super(MrcnnTableDetect, self).__init__(alg_params, alg_inputs,
                                               alg_ouputs, **kwargs)
...
class MrcnnTableCellDetect(Mrcnn):
    def __init__(self, alg_params, alg_inputs, alg_ouputs, **kwargs):
        super(MrcnnTableCellDetect, self).__init__(alg_params, alg_inputs,
                                                   alg_ouputs, **kwargs)
...
class MrcnnTableRowColDetect(Mrcnn):
    def __init__(self, alg_params, alg_inputs, alg_ouputs, **kwargs):
        super(MrcnnTableRowColDetect, self).__init__(alg_params, alg_inputs,
                                                     alg_ouputs, **kwargs)
