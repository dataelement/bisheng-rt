 ...
 */
#ifndef TRT_RESIZEBILINEAR_PLUGIN_H
#define TRT_RESIZEBILINEAR_PLUGIN_H
...
namespace nvinfer1 {
namespace plugin {
class ResizeBilinear : public IPluginV2Ext {
 public:
  ResizeBilinear(float scale);

  ResizeBilinear(const void* data, size_t length);

  ~ResizeBilinear() override = default;
...
class ResizeBilinearPluginCreator : public BaseCreator {
 public:
