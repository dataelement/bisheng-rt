 ...
 */
#ifndef TRT_OCR_PYRAMID_ROIALIGN_PLUGIN_H
#define TRT_OCR_PYRAMID_ROIALIGN_PLUGIN_H
...
class OcrPyramidROIAlign : public IPluginV2Ext {
 public:
  OcrPyramidROIAlign(int pooled_size, int mPadBorder);

  OcrPyramidROIAlign(const void* data, size_t length);

  ~OcrPyramidROIAlign() override = default;
...
class OcrPyramidROIAlignPluginCreator : public BaseCreator {
 public:
  OcrPyramidROIAlignPluginCreator();
...
#endif // TRT_OCR_PYRAMID_ROIALIGN_PLUGIN_H
