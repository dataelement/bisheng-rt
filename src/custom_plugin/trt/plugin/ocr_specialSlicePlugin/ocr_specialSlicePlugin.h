 ...
 */
#ifndef TRT_OCR_SPECIAL_SLICE_PLUGIN_H
#define TRT_OCR_SPECIAL_SLICE_PLUGIN_H
...
namespace nvinfer1 {
namespace plugin {
class OcrSpecialSlice : public IPluginV2Ext {
 public:
  OcrSpecialSlice();

  OcrSpecialSlice(const void* data, size_t length);

  ~OcrSpecialSlice() override = default;
...
class OcrSpecialSlicePluginCreator : public BaseCreator {
 public:
  OcrSpecialSlicePluginCreator();

  ~OcrSpecialSlicePluginCreator() noexcept override = default;
