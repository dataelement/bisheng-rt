 ...
 */
#ifndef TRT_OCR_PROPOSAL_LAYER_PLUGIN_H
#define TRT_OCR_PROPOSAL_LAYER_PLUGIN_H
#include <cassert>
...
class OcrProposalLayer : public IPluginV2Ext {
 public:

  OcrProposalLayer(int prenms_topk, int keep_topk, float iou_threshold, int mMaxSide);

  OcrProposalLayer(const void* data, size_t length);

  ~OcrProposalLayer() override = default;
...
class OcrProposalLayerPluginCreator : public BaseCreator {
 public:
  OcrProposalLayerPluginCreator();
