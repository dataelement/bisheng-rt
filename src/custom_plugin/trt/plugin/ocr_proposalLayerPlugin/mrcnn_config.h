...
// static const nvinfer1::DimsCHW IMAGE_SHAPE{3, 1600, 1600};
...
static const std::vector<float> RPN_ANCHOR_SCALES = {16, 32, 64, 128, 256};

// Ratios of anchors at each cell (width/height)
// A value of 1 represents a square anchor, and 0.5 is a wide anchor
static const float RPN_ANCHOR_RATIOS[] = {0.1, 0.2, 0.5, 0.8, 1.0, 1.5, 2, 5, 10};
