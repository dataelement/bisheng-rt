 ...
 */
#ifndef TRT_OCR_DETECTION_LAYER_PLUGIN_H
#define TRT_OCR_DETECTION_LAYER_PLUGIN_H
#include <cassert>
...
class OcrDetectionLayer : public IPluginV2Ext {
 public:

  OcrDetectionLayer(int num_classes, int keep_topk, float score_threshold, float iou_threshold, int max_size);

  OcrDetectionLayer(const void* data, size_t length);

  ~OcrDetectionLayer() override = default;
...
class OcrDetectionLayerPluginCreator : public BaseCreator {
 public:
  OcrDetectionLayerPluginCreator();
