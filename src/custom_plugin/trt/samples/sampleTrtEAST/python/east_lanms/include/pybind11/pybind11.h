...
class cpp_function : public function {
 ...
 protected:
  ...
  void initialize(Func &&f, Return (*)(Args...), const Extra&... extra) {
    ...
    struct capture {
      detail::remove_reference_t<Func> f;
    };
...
#  pragma GCC diagnostic pop
      ...
      if (!std::is_trivially_destructible<Func>::value)
        rec->free_data = [](detail::function_record *r) {
...
inline void call_operator_delete(void *p, size_t) {
  ::operator delete(p);
}
...
class class_ : public detail::generic_type {
 ...
 public:
  ...
  class_ &def_buffer(Return (Class::*func)(Args...)) {
    return def_buffer([func] (type &obj) {
      return (obj.*func)();
    });
  }
  ...
  class_ &def_buffer(Return (Class::*func)(Args...) const) {
    return def_buffer([func] (const type &obj) {
      return (obj.*func)();
    });
  }
...
template <typename Type> class enum_ : public class_<Type> {
 public:
  ...
  enum_(const handle &scope, const char *name, const Extra&... extra)
    ...
    def("__init__", [](Type& value, Scalar i) {
      value = (Type)i;
    });
    def("__int__", [](Type value) {
      return (Scalar) value;
    });
#if PY_MAJOR_VERSION < 3
    def("__long__", [](Type value) {
      return (Scalar) value;
    });
#endif
    ...
    if (std::is_convertible<Type, Scalar>::value) {
      ...
      if (is_arithmetic) {
        ...
        def("__invert__", [](const Type &value) {
          return ~((Scalar) value);
        });
    ...
    def("__hash__", [](const Type &value) {
      return (Scalar) value;
    });
    // Pickling and unpickling -- needed for use with the 'multiprocessing' module
    def("__getstate__", [](const Type &value) {
      return pybind11::make_tuple((Scalar) value);
    });
    def("__setstate__", [](Type &p, tuple t) {
      new (&p) Type((Type) t[0].cast<Scalar>());
    });
  }
...
template <typename... Args> struct init {
  ...
  static void execute(Class &cl, const Extra&... extra) {
    ...
    cl.def("__init__", [](Base *self_, Args... args) {
      new (self_) Base(args...);
    }, extra...);
  }
...
template <typename... Args> struct init_alias {
  ...
  static void execute(Class &cl, const Extra&... extra) {
    using Alias = typename Class::type_alias;
    cl.def("__init__", [](Alias *self_, Args... args) {
      new (self_) Alias(args...);
    }, extra...);
  }
};
...
template <typename... Args> detail::init<Args...> init() {
  return detail::init<Args...>();
}
template <typename... Args> detail::init_alias<Args...> init_alias() {
  return detail::init_alias<Args...>();
}
