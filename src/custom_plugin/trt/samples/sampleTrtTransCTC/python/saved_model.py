...
def convert_model(src_name, dst_name, ignore=None):
    ...
    variables_dic, variables_dic_origin = save_weights(sess, save_variables)
    np.savez(os.path.join(src_name, 'trans_ctc_weights_trt.npz'), dic=variables_dic_origin)
...
if __name__ == "__main__":
    ...
    src_name = '../../../build/test_data/models/ctc-revive/1.1'
    dst_name = '../../../build/test_data/models/ctc-revive/1.1/trans_ctc_weights_trt.wts'

    convert_model(src_name, dst_name)
    loadweight(dst_name)
