# flake8: noqa
import numpy as np
from pybackend_libs.dataelem.model.embedding.gte import GTEEmbedding


def test_gte_emb():
    params = {
        'pretrain_path': '/home/public/llm/gte-large',
        'devices': '8',
        'gpu_memory': 3
    }
