...
model_config = {
  'parameters': {
    ...
    'model_params': "{\"pymodel_type\", \"ocr.LatexDetector\", \"dep_model_name\": \"latex_det_graph_v1\"}",
    'gpu_memory': '3',
...
#     "pymodel_type": "ocr.LatexDetector",
#     "pymodel_params": "{\"dep_model_name\": \"latex_det_graph_v1\"}",
#     "gpu_memory": "2",
